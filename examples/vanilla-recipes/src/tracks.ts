/**
 * Invented tracks for the vertical playlist stack. Each gets a two-stop CSS
 * gradient instead of cover art: there is no licensed artwork to show, and a
 * gradient reads as album art without pretending to be a photo.
 *
 * Ported verbatim from examples/vertical-stack/src/tracks.ts.
 */
