/**
 * Invented films, shared by the programmatic-control and forms-in-cards
 * recipes. Each gets a two-stop CSS gradient instead of artwork, since there
 * is no licensed poster art to show.
 *
 * Ported verbatim from examples/react-movie-stack/src/films.ts.
 */
