 ...
 * creation, independent of its position in the array, so cards already on
 * screen are never disturbed by growth appending more.
 *
 * Ported verbatim from examples/react-infinite-feed/src/cards.ts.
 */
