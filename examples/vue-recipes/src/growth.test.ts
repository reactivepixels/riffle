...
describe('shouldGrow', () => {
  ...
  it('stays false on every render across a simulated loading window', () => {
    ...
    // re-renders (and so re-evaluates shouldGrow) several times during it.
    // A correct guard answers false every single time after the first.
